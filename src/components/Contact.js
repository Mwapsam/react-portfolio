...
const Contact = () => (
  <div name="contact" className="w-full h-screen bg-[#0a192f] flex justify-center items-center p-4">
    <form method="POST" action="https://getform.io/f/70f907f8-d849-4e25-a35d-5df24a1dabc9" className="flex flex-col max-w-[600px] w-full">
      ...
      <button type="submit" className="text-white border-2 hover:bg-blue-600 hover:border-blue-600 px-4 py-3 my-8 mx-auto flex items-center">Let&apos;s Collaborate</button>
    </form>
  </div>
);
